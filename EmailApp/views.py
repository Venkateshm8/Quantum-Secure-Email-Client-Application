...
def ComposeMailAction(request):
    if request.method == 'POST':
        ...
        count = 0
        mysqlConnect = pymysql.connect(host='127.0.0.1',port = 3306,user = 'root', password = 'venkatesh', database = 'SecureEmail',charset='utf8')
        with mysqlConnect:
        ...
        dbconnection = pymysql.connect(host='127.0.0.1',port = 3306,user = 'root', password = 'venkatesh', database = 'SecureEmail',charset='utf8')
